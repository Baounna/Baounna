...
| [⚽ Football Match Analytics](https://github.com/Baounna/OOPMINIPROJECT) | Object-oriented analysis of a match (StatsBomb) computing xG, xT & VAEP with unit tests and a Streamlit dashboard | `Python` `OOP` `Streamlit` |
